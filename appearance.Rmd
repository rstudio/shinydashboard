...
In some cases, the title that you wish to use won't fit in the default width in the header bar. You can make the space for the title wider with some custom CSS. In this example, we've increased the width for the title to 450 pixels, and also set the background color of the title area to be the same as the rest of the header bar.
