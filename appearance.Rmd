...
There are two color themes, or skins: blue and black. The default is blue. You can choose which theme to use with `dashboardPage(skin = "blue")` or `dashboardPage(skin = "black")`.
